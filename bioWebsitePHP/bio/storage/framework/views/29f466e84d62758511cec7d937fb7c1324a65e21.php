<!doctype html>
 <html lang="<?php echo e(app()->getLocale()); ?>">
     <head>
         ...
         <link rel="stylesheet" href="<?php echo e(URL::asset('css/career.css')); ?>">
         
         <!-- Scripts -->
         <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/tether/1.4.0/js/tether.min.js"></script>
         <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
         <script type="text/javascript" src="<?php echo e(asset('js/career.js')); ?>"></script>
     ...
     <body>
         ...
         <div class="links section-header">
             ...
             <a href="https://www.linkedin.com/in/emilykoh94/"><img alt="linkedin profile" width="200" height="50" title="Connect with me on LinkedIn!" src="<?php echo e(URL::asset('/images/linkedin.png')); ?>"></a>
             <a href="https://github.com/kisa411"><img alt="github profile" width="150" height="50" title="Check out my Github Profile!" src="<?php echo e(URL::asset('/images/github.png')); ?>"></a>
         </div>
